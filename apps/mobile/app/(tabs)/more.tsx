...
export default function MoreScreen() {
  ...
  return <Screen><PageHeader eyebrow="Account & field settings" title="More" subtitle="Your notices, device readiness and privacy information in one place." />
    ...
    <View style={styles.group}><Text style={styles.groupTitle}>My details</Text>
      <Pressable style={styles.row} onPress={() => router.push('/profile' as never)} accessibilityRole="button"><View style={styles.rowBody}><Text style={styles.rowTitle}>My profile</Text><Text style={styles.rowCopy}>Phone, mapped home/school locations, travel and weekly availability.</Text></View><Text style={styles.arrow}>›</Text></Pressable>
      <Pressable style={styles.row} onPress={() => router.push('/feedback' as never)} accessibilityRole="button" accessibilityLabel="Open my feedback"><View style={styles.rowBody}><View style={styles.rowTitleWithIcon}><Ionicons name="star-outline" size={17} color={colors.primary} /><Text style={styles.rowTitle}>My feedback</Text></View><Text style={styles.rowCopy}>See ratings and comments recorded about your own work.</Text></View><Text style={styles.arrow}>›</Text></Pressable>
    </View>
