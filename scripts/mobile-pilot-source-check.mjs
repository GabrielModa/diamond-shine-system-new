...
expect('apps/mobile/app/visit/[id].tsx', 'Anything Operations should know?', 'guided finish report question')
expect('apps/mobile/app/visit/[id].tsx', 'Save & finish', 'guided finish final save')
expect('apps/mobile/app/visit/[id].tsx', 'visitPhotoMissing', 'service-aware closeout photo requirement')
reject('apps/mobile/app/visit/[id].tsx', 'Submit & finish visit', 'separate submit step')
