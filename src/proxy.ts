...
export const config = {
  matcher: ['/home', '/clients', '/work-orders', '/operations', '/schedule', '/timesheets', '/field-control', '/quality', '/insights', '/supplies', '/my-requests', '/feedback', '/dashboard', '/users', '/communications', '/audit'],
}
