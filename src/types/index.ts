...
export type Page = 'home' | 'clients' | 'work-orders' | 'operations' | 'schedule' | 'timesheets' | 'field-control' | 'quality' | 'insights' | 'people' | 'supplies' | 'my-requests' | 'feedback' | 'dashboard' | 'users' | 'communications' | 'audit'
