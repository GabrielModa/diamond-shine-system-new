...
export const DEMO_SITE_SCENARIOS: DemoSiteScenario[] = [
  ...
  { externalId:'scenario-liffey-tech', client:'Liffey Tech Labs', site:'Grand Canal Office', addressLine1:'Grand Canal Square', city:'Dublin', postalCode:'D02', latitude:53.3398, longitude:-6.2397, startMinute:7*60, durationMinutes:180, employeeEmails:['employee@ds.ie','liam@ds.ie'], tags:['needs-staff','morning','technology'] },
  { externalId:'scenario-greenpark-care', client:'Greenpark Care', site:'Terenure Residence', addressLine1:'Terenure Road East', city:'Dublin', postalCode:'D06', latitude:53.3107, longitude:-6.2831, startMinute:14*60, durationMinutes:210, employeeEmails:['maria@ds.ie','niamh@ds.ie'], tags:['needs-staff','afternoon','residential-care'] },
  { externalId:'scenario-harbour-retail', client:'Harbour Retail Group', site:'Dún Laoghaire Store', addressLine1:'Marine Road', city:'Dún Laoghaire', postalCode:'A96', latitude:53.2924, longitude:-6.1359, startMinute:19*60, durationMinutes:150, employeeEmails:['sofia@ds.ie','gabriel.moda@ds.ie'], tags:['covered','evening','retail'] },
]
