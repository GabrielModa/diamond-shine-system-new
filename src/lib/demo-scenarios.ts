...
export const DEMO_SITE_SCENARIOS: DemoSiteScenario[] = [
  { externalId:'scenario-merrion-dental', client:'Alder Dental Group', site:'Rowan Clinic', addressLine1:'26 Demo Clinic Road', city:'Dublin', postalCode:'D06 D2P4', latitude:53.3264, longitude:-6.2562, startMinute:6*60+30, durationMinutes:150, employeeEmails:['niamh@ds.ie','maria@ds.ie'], tags:['early-morning','healthcare'] },
  { externalId:'scenario-northstar', client:'Northwind Property', site:'Summit Offices', addressLine1:'Central Demo Park', city:'Dublin', postalCode:'D18', latitude:53.2774, longitude:-6.2057, startMinute:18*60, durationMinutes:180, employeeEmails:['gabriel.moda@ds.ie','lucas@ds.ie'], tags:['evening','large-office'] },
  { externalId:'scenario-cedar-hotel', client:'Solstice Hotels', site:'Harbour Hotel', addressLine1:'North Demo Quay', city:'Dublin', postalCode:'D01', latitude:53.3487, longitude:-6.2407, startMinute:11*60, durationMinutes:240, employeeEmails:['liam@ds.ie','aisha@ds.ie'], tags:['daytime','hospitality'] },
  { externalId:'scenario-dublin-arts', client:'Lantern Arts Collective', site:'Copper Square Gallery', addressLine1:'Demo Arts Square', city:'Dublin', postalCode:'D02', latitude:53.3454, longitude:-6.2660, startMinute:20*60, durationMinutes:120, employeeEmails:['omar@ds.ie','employee@ds.ie'], tags:['late-evening','public-space'] },
  { externalId:'scenario-phoenix-logistics', client:'Atlas Logistics', site:'Westpoint Hub', addressLine1:'Westpoint Demo Estate', city:'Dublin', postalCode:'D12', latitude:53.3090, longitude:-6.3500, startMinute:5*60+30, durationMinutes:180, employeeEmails:['daniel@ds.ie','lucas@ds.ie'], tags:['very-early','industrial'] },
  { externalId:'scenario-riverstone', client:'Brightpath Learning', site:'Maple Campus', addressLine1:'Demo Campus Road', city:'Dublin', postalCode:'D06', latitude:53.3229, longitude:-6.2648, startMinute:16*60+30, durationMinutes:150, employeeEmails:['sofia@ds.ie','emma@ds.ie'], tags:['afternoon','education'] },
  { externalId:'scenario-beacon-fitness', client:'Elevate Fitness', site:'Riverside Club', addressLine1:'Demo Riverside Road', city:'Dublin', postalCode:'D04', latitude:53.3317, longitude:-6.2315, startMinute:21*60, durationMinutes:120, employeeEmails:['aoife@ds.ie','john@ds.ie'], tags:['night','fitness'] },
  { externalId:'scenario-liffey-tech', client:'Novus Labs', site:'Quayside Office', addressLine1:'Demo Innovation Quay', city:'Dublin', postalCode:'D02', latitude:53.3398, longitude:-6.2397, startMinute:7*60, durationMinutes:180, employeeEmails:['employee@ds.ie','liam@ds.ie'], tags:['needs-staff','morning','technology'] },
  { externalId:'scenario-greenpark-care', client:'Willow Care', site:'Garden Residence', addressLine1:'Garden Demo Road', city:'Dublin', postalCode:'D06', latitude:53.3107, longitude:-6.2831, startMinute:14*60, durationMinutes:210, employeeEmails:['maria@ds.ie','niamh@ds.ie'], tags:['needs-staff','afternoon','residential-care'] },
  { externalId:'scenario-harbour-retail', client:'Oak & Finch Retail', site:'Seafront Store', addressLine1:'Seafront Demo Road', city:'Dún Laoghaire', postalCode:'A96', latitude:53.2924, longitude:-6.1359, startMinute:19*60, durationMinutes:150, employeeEmails:['sofia@ds.ie','gabriel.moda@ds.ie'], tags:['covered','evening','retail'] },
]
