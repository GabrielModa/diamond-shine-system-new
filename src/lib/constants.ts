...
export const PAGE_ACCESS: Record<UserRole, Page[]> = {
  admin: ['home', 'operations', 'schedule', 'field-control', 'insights', 'supplies', 'my-requests', 'feedback', 'dashboard', 'users', 'communications', 'audit'],
  supervisor: ['home', 'operations', 'schedule', 'field-control', 'insights', 'supplies', 'my-requests', 'feedback', 'communications'],
